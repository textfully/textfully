      ...
      <div className="prose prose-invert max-w-none">
        <section className="mb-12">
          <p className="text-zinc-300 leading-relaxed">
            This Privacy Policy for gtfol, LLC ("we," "us," or "our"), describes
          ...
          <ul className="list-disc pl-6 mt-4 mb-8 text-zinc-300 space-y-2">
            <li>
              Visit our website at textfully.dev, or any website of ours that
              links to this Privacy Policy
            </li>
            <li>
              Use Textfully. Textfully is an open-source Twilio alternative that
              lets developers send texts easily.
            </li>
            <li>
          ...
          <div className="mb-8">
            ...
            <div className="mb-6">
              ...
              <p className="text-zinc-300">
                ...
                RevenueCat. You may find their privacy privacy link(s) here:{" "}
                <a
              ...
              <table className="w-full text-left mb-4 border-collapse border border-zinc-700">
                <thead>
                  <tr className="bg-zinc-800">
                    ...
                    <th className="px-4 py-2 border border-zinc-700 w-24">
                      Collected
                    </th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-zinc-700">
                  <tr className="hover:bg-zinc-900">
                    <td className="px-4 py-2 border border-zinc-700 align-top">
                      A. Identifiers
                    </td>
          ...
          <div className="mb-8">
            ...
            <div className="bg-zinc-800 p-6 rounded-lg mb-8">
              <p className="text-zinc-300">
                ...
                "sale"/"sharing" under applicable US state laws, you can opt out
                as described in the section "DO UNITED STATES RESIDENTS HAVE
            ...
            <p className="text-zinc-300">
              ...
              <a
                href="https://textfully.dev/legal/cookies"
                className="text-blue-400 hover:text-blue-300"
              >
                https://textfully.dev/legal/cookies
              </a>
              .
            </p>
          </div>
        ...
        <section id="section6" className="mb-16">
          ...
          <div className="mb-8">
            ...
            <p className="text-zinc-300 mb-6">
              ...
              innovative solutions. The terms in this Privacy Policy govern your
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-zinc-300">
                  ...
                  our AI Products for purposes outlined in "WHAT LEGAL BASES DO
                  WE RELY ON TO PROCESS YOUR PERSONAL INFORMATION?" You must not
              ...
              <div>
                ...
                <p className="text-zinc-300">
                  ...
                  handled in line with our Privacy Policy and our agreement with
        ...
        <section id="section8" className="mb-16">
          ...
          <div className="mb-8">
            ...
            <p className="text-zinc-300 mb-6">
              ...
              your information may be transferred to, stored by, and processed
              by us in our facilities and in the facilities of the third parties
              with whom we may share your personal information (see "WHEN AND
              WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?" above), in the
        ...
        <section id="section9" className="mb-16">
          ...
          <div className="mb-8">
            ...
            <p className="text-zinc-300 mb-6">
              ...
              privacy policy will require us keeping your personal information
              for longer than twelve (12) months past the termination of the
              user's account.
            </p>
